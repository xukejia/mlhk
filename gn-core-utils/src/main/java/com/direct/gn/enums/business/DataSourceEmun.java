 ...
 *
 */
public enum DataSourceEmun implements BaseEmun
{
	GW("1","官网"),
	JINTONG("2","今通"),
	PKFARE("3","PKFARE");
	
	private DataSourceEmun(String code ,String msg)
	{
		this.code = code;
		this.msg = msg;
	}
	...
	public static DataSourceEmun emunByCode(String code)
	{
		for (DataSourceEmun e : DataSourceEmun.values())
		{
