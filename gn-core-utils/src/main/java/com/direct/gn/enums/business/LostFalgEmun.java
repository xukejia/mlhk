 ...
 *
 */
public enum LostFalgEmun implements BaseEmun
{
	GAIN("1","盈利"),
	LOSS("2","亏损");

	private LostFalgEmun(String code ,String msg)
	{
		this.code = code;
		this.msg = msg;
	}
	...
	public static LostFalgEmun emunByCode(String code)
	{
		for (LostFalgEmun e : LostFalgEmun.values())
		{
