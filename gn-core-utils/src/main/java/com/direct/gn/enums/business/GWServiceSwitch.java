 ...
 *
 */
public enum GWServiceSwitch implements BaseEmun
{
	TAOBAO("10","淘宝"),
	QUNAR("20","去哪儿"),
	CTRIP("30","携程"),
	...
	private GWServiceSwitch(String code ,String msg)
	{
		this.code = code;
		this.msg = msg;
	}
	...
	public static GWServiceSwitch emunByCode(String code)
	{
		for (GWServiceSwitch e : GWServiceSwitch.values())
		{
