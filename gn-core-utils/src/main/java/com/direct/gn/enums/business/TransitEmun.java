 ...
 *
 */
public enum TransitEmun implements BaseEmun
{
	ONEWAY("1","单程"),	
	TRANSIT("2","中转");

	private TransitEmun(String code ,String msg)
	{
		this.code = code;
		this.msg = msg;
	}
	...
	public static TransitEmun emunByCode(String code)
	{
		for (TransitEmun e : TransitEmun.values())
		{
