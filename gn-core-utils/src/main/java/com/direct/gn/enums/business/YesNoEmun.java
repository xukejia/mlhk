 ...
 *
 */
public enum YesNoEmun implements BaseEmun
{
	
	N("0" , "否"),
	Y("1" , "是");
	private YesNoEmun(String code ,String msg)
	{
		this.code = code;
		this.msg = msg;
	}
	...
	public static YesNoEmun emunByCode(String code)
	{
		for (YesNoEmun e: YesNoEmun.values())
		{
