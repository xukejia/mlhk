 ...
 *
 */
public enum RebateTypeEmun implements BaseEmun
{
	NotContainTax("0","票面返"),
	ContainTax("1","含税返");
	private RebateTypeEmun(String code ,String msg)
	{
		this.code = code;
		this.msg = msg;
	}
	...
	public static RebateTypeEmun emunByCode(String code)
	{
		for (RebateTypeEmun e : RebateTypeEmun.values())
		{
