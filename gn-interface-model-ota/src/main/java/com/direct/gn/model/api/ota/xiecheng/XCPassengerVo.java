...
public class XCPassengerVo implements Serializable{
	private String name;         //LastName/FirstName MiddleName，姓/名
	private Integer ageType;     //乘客类型，0 成人/1 儿童/-1 留学生
	...
	private XCFFPNo ffpNo;  // 常旅客信息，参考下面的FFPNo Element
	...
	public XCFFPNo getFfpNo() {
		return ffpNo;
	}

	public void setFfpNo(XCFFPNo ffpNo) {
		this.ffpNo = ffpNo;
	}
}
