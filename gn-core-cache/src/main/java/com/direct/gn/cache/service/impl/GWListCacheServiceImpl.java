 ...
 *
 */
public class GWListCacheServiceImpl<T extends Serializable> extends AbstractRedisCacheService<T>
{
	@Resource
	private RedisTemplate<String, T> redisCacheTemplateGWList;
	...
	{
		return this.redisCacheTemplateGWList;
	}
