 ...
 *
 */
public class OtherPolicyCacheServiceImpl<T extends Serializable> extends AbstractRedisCacheService<T>
{
	@Resource
	private RedisTemplate<String, T> redisCacheTemplateOtherPolicy;
	...
	{
		return this.redisCacheTemplateOtherPolicy;
	}
