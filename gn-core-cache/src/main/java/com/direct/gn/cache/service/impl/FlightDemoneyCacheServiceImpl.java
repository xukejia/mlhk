 ...
 *
 */
public class FlightDemoneyCacheServiceImpl<T extends Serializable> extends AbstractRedisCacheService<T>
{
	@Resource
	private RedisTemplate<String, T> redisCacheTemplateFlightDemoney;
	...
	{
		return this.redisCacheTemplateFlightDemoney;
	}
