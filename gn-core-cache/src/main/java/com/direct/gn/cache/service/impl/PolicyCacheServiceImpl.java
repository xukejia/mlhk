 ...
 *
 */
public class PolicyCacheServiceImpl<T extends Serializable> extends AbstractRedisCacheService<T>
{
	@Resource
	private RedisTemplate<String, T> redisCacheTemplatePolicy;
	...
	{
		return this.redisCacheTemplatePolicy;
	}
