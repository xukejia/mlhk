 ...
 *
 */
public class QNPolicyCacheServiceImpl<T extends Serializable> extends AbstractRedisCacheService<T>
{
	@Resource
	private RedisTemplate<String, T> redisCacheTemplatePolicyQU;
	...
	{
		return this.redisCacheTemplatePolicyQU;
	}
