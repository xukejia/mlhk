 ...
 *
 */
public class JedisCacheServiceImpl<T extends Serializable> extends AbstractRedisCacheService<T>
{
	@Resource
	private RedisTemplate<String, T> redisCacheTemplateJedis;
	...
	{
		return this.redisCacheTemplateJedis;
	}
